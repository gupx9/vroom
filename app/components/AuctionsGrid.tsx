...
export default function AuctionsGrid({ auctions, bannedUntil }: AuctionsGridProps) {
    ...
    <div>
      ...
      {auctions.length === 0 && (
        <div className="pt-16 text-center text-zinc-600 py-24">
          ...
          <p className="text-sm mt-1 text-zinc-600">Be the first — click &ldquo;Start Auction&rdquo; to list a car</p>
        </div>
      )}
